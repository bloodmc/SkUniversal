...
@Name("GriefDefender - Lesser Corner")
...
public class ExprLesserCorner extends SimpleExpression<Location> {
    ...
    static {
        Skript.registerExpression(ExprLesserCorner.class, Location.class, ExpressionType.COMBINED, "[the] lesser [boundary] corner [loc[ation]] of [the] [G[rief]D[efender]] claim [with ID] %number%");
    }
    ...
    protected Location[] get(Event e) {
        ...
        final Vector3i vec = claim.getLesserBoundaryCorner();
